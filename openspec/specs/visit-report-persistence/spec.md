...
Governs how post-visit reports submitted through the API are persisted in the `visit_reports` table, including the success and rejection paths for valid and invalid submissions.
