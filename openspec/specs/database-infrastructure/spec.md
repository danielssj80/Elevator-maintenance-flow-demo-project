...
Governs how the database schema is managed (Alembic-only), how the fleet is seeded deterministically and idempotently, how configuration is provided through the environment, and how the test suite isolates its database state from development.
